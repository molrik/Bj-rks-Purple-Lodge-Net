...
if (isset($_POST['Submit_incsolo'])) {
	if (isset($_POST['incsolo'])) {
		$_SESSION['show_all_on_sugar'] = 1;
	} else {
		$_SESSION['show_all_on_sugar'] = 0;
	}
}
...
if (!(isset($_SESSION['show_all_on_sugar']) && $_SESSION['show_all_on_sugar'])) {
	$selartist = " AND artist IN ('Tappi Tíkarrass','Kukl','Sugarcubes','Sykurmolarnir','Johnny Triumph and the Sugarcubes')"; //ONLY the groups
} else {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="height:100%">
  <tr>
    <td width="150" height="150" align="center" valign="middle" id="leftcorner"><img src="syspics/cubes.gif" alt="Corner" name="corner" width="140" height="140" border="0" id="corner" /></td>
    <td height="150" align="center" valign="middle" id="topmenu">
	<h3>
	<a href="<?php echo $_SERVER['PHP_SELF']; ?>">List of songs</a>
	<?php if (!(isset($_SESSION['show_all_on_sugar']) && $_SESSION['show_all_on_sugar'])) { ?>
		- groups only
	<?php } else { ?>
  ...
  <tr>
	...
	<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" name="listallsongs" id="listallsongs" class="xsmall">	
	  <table border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td>Include solo works</td>
			<td>
			<input name="incsolo" type="checkbox" id="incsolo" value="x" <?php if (isset($_SESSION['show_all_on_sugar']) && $_SESSION['show_all_on_sugar']) { echo "checked=\"checked\""; } ?>  onclick="document.getElementById('listallsongs').submit()" /><input name="Submit_incsolo" type="hidden" id="Submit_incsolo" value="1" />
			</td>
		  </tr>
		</table>
	</form>	
