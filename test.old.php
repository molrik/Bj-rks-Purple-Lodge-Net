...
//if (!isset($_GET['year'])) { $_GET['year']=date("Y"); }; //just a precaution
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="height:100%">
  <tr>
    <td width="150" height="150" align="center" valign="middle" style="background-image:url(syspics/corner2.jpg)"><img src="syspics/rose.gif" alt="Corner" name="corner" width="140" height="140" border="0" id="corner" /></td>
...
<table width="98%" border="0" cellpadding="2" cellspacing="2" class="sides">
  ...
  <?php if (trim($row_img['image'])!="") { $l = 1; } else { $l = 0; } ; ?>
  <?php if ($l) { ?>
  <a href="<?php if (substr(strtolower(trim($row_img['image'])),0,4)!="http") { echo "images"; ?>/<?php } ?><?php echo $row_img['image']; ?>">
  <?php } ?>
...
<tr>	
    ...
    <td valign="top">Who is it? (04)</td>
</tr>
  <tr valign="top">
    <td>The triumph of a heart (05)</td>
  </tr>
<tr>	
...
<tr>	
    ...
    <td valign="top">Earth intruders (07)</td>
</tr>
...
mysql_free_result($relyear);

mysql_free_result($relletter);

mysql_free_result($reltitle);
?>
