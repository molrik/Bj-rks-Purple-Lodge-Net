...
if (isset($_POST['upload'])) {
	...
	// start-limitation
	  ...
	  $upf = true;
	  $_SESSION['latest'] = $_FILES["upfil"]["name"];	//save latest upload for later
	} else {
  ...
  <tr>
	...
	<?php } 
		if (isset($_SESSION['latest'])) {
			$th_latest = $_SESSION['latest'];
			echo "<p class=\"xsmall\">Recent upload: <a href=\"#\" onClick=\"self.opener.document.".$_GET['ret'].".value='".$th_latest."';window.close();\" >".$th_latest."</a></p>"; 
		}
	?>
