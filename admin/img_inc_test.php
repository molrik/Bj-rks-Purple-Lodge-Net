...
?>
<table width="98%" border="0" cellpadding="1" cellspacing="1" class="updrel" id="pic_table">
	<tr>
		<td>
					 ...
					 <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="get" name="upd_rel_img">
					  <table border="0" cellpadding="1" cellspacing="1" width="100%">
						<tr>
					      ...
					      <a href="javascript:open_filelist('img_popup_upload_thumbz.php','upd_rel_img.thumb_input');">
