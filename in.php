...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="height:100%">
  <tr>
    <td width="150" height="150" align="center" valign="middle" id="leftcorner"><img src="syspics/molrik.gif" alt="Corner" name="corner" width="140" height="140" border="0" id="corner" /></td>
    <td height="150" align="center" valign="middle" id="topmenu">Bj&ouml;rks Purple Lodge</td>
  </tr>
  <tr>
    <td width="150" align="center" valign="top"><?php include("menu.inc.php"); ?></td>
    <td align="center" valign="middle">Under construction - a new database-driven site coming up! </td>
  </tr>
</table>
</body>
</html>
